        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    person_height = box_height*0.516-17.33
            ...
            FPS1 = 1/(T3-t0)
            t0=T3
            FPS_print = f'FPS: {FPS1:.0f}'
            print(f'{s}--------FPS: {FPS1:.0f} Done. ({t2 - t1:.3f}s)')

            cv2.putText(im0, text=FPS_print, org=(3, 40), fontFace=cv2.FONT_HERSHEY_SIMPLEX,
                    fontScale=0.50, color=(255, 0, 0), thickness=2)
            cv2.line(im0, (200,450), (640,450),(255,255,0),thickness=3)  # 발끝 기준선 그리기
